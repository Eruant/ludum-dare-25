    ...
    , update: {
        ...
        , requestAnimFrame: function() {
            var currentTime = new Date().getTime()
              , timePassed = (currentTime - window.essence.system.lastUpdate)
              , s = window.essence.system
              , i
            ;

            window.essence.system.lastUpdate = currentTime;

            if(currentTime - window.essence.system.lastDraw > 16) {
              ...
              window.essence.system.lastDraw = currentTime;
            }
